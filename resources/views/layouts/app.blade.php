...
<body>
      ...
      <div class="w-full h-16" id="confirmBtn">
        <div class="w-full grid grid-cols-2 h-full">
          ...
          <div class="col-span-1">
            <button class="w-full h-full block mx-auto px-4 py-1 rounded-br-lg text-white font-bold text-md md:text-lg" style="background:rgb(88,183,189)" onclick="onReleaseClick('releaseConfirm')">Yes</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="giftConfirmModal" class="h-screen w-screen bg-black bg-opacity-70 fixed top-0 z-50 hidden">
    <div class="w-11/12 h-48 bg-white absolute rounded-xl" style="top:50%; margin-top:-6rem; left:50%; margin-left:-45.83333%;" id="modalBody">
      ...
      <div class="w-full h-16" id="confirmBtn">
        <div class="w-full grid grid-cols-2 h-full">
          <div class="col-span-1 h-full">
            <button class="w-full h-full block mx-auto px-4 py-1 rounded-bl-lg text-gray-500  text-md md:text-lg bg-white" onclick="$('div#giftConfirmModal').hide()">Cancel</button>
          </div>
          <div class="col-span-1">
            <button class="w-full h-full block mx-auto px-4 py-1 rounded-br-lg text-white font-bold text-md md:text-lg" style="background:rgb(88,183,189)" onclick="onReleaseClick('giftConfirm')">Yes</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <div id="reviewModal" class="h-screen w-screen bg-black bg-opacity-70 fixed top-0 z-50 hidden">
    <div class="w-11/12 h-68 bg-white absolute rounded-xl" style="top:50%; transform:translateY(-50%); left:50%; margin-left:-45.83333%;" id="modalBody">
      <div class="w-10/12 mx-auto h-26 mt-4">
        ...
        <p class="text-center text-sm md:text-md text-gray-500 mt-3 mb-3">You have completed your project.<br/><span class="font-bold text-gray-700">PLEASE LEAVE A REVIEW!</span><br/></p>
      </div>
      <div class="w-full h-16" id="confirmBtn">
        <div class="w-full grid grid-cols-2 h-full">
          <div class="col-span-1 h-full">
            ...
            <div class="w-full fixed bottom-0 z-50">
              <div class="bg-white w-full md:max-w-7xl mx-auto object-center" id="mobile-menu">
                  ...
                  <a href="{{ route('inbox') }}" class="text-gray-400 text-xl md:text-2xl hover:text-black block py-2 text-center unread" id="inbox">
                    ...
                    <a href="{{ route('task', ['item'=>'accepted']) }}" id="task" class="text-gray-400 text-xl md:text-2xl hover:text-black block py-2 text-center">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <ul class="w-11/12 mx-auto">
                          ...
                          <li class="my-4"><a href={{ route('balance') }}><li class="fas fa-wallet inline-block w-7"></li>Balance</a></li>
                          <li class="my-4"><a href={{ route('referrals') }}><li class="fas fa-sync-alt inline-block w-7"></li>Referrals</a></li>
                          <li class="my-4"><a href={{ route('saved') }}><li class="fas fa-heart inline-block w-7"></li>Saved</a></li>
                          <li class="my-4"><a href="{{ route('accountSetting') }}"><li class="fas fa-cog inline-block w-7"></li>Account Settings</a></li>
                      </ul>
                    </div>
                    ...
                    <div class="modal-footer">
                        <form action="{{ route('logout') }}" id="logout-form" method="post">
                            {{ csrf_field() }}
                            <button type="button" onclick="logout()"><i class="inline-block w-7 fas fa-sign-out-alt"></i> Log Out</button>
                        </form>
                    </div>
                  </div>
                </div>
  ...
  <script>
    $(document).ready(function() {
        var transactionHeight = window.innerHeight - 475;
